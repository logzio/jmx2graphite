...
public class MetricsPipeline implements Job {
    ...
    @Inject
    public MetricsPipeline(Jmx2GraphiteConfiguration conf) {
    ...
    public MetricsPipeline(String jolokiaUrl, String graphiteHostname, int graphitePort, String serviceName,
